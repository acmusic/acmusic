...
( function( $ ) {
	...
	//--FRONT PAGE COLORS
	//connections section
	wp.customize('connections_bg',function( value ) {
		value.bind( function( newval ) {
			$('.connections-area').css('background-color', newval );
		} );
	});
	wp.customize('connections_title',function( value ) {
		value.bind( function( newval ) {
			$('.connections-area .widget-title').css('color', newval );
		} );
	});
	wp.customize('connections_icon_bg',function( value ) {
		value.bind( function( newval ) {
			$('.connection-icon').css('background-color', newval );
		} );
	});
	wp.customize('connections_item_title',function( value ) {
		value.bind( function( newval ) {
			$('.connection-title, .connection-title a').css('color', newval );
		} );
	});
	wp.customize('connections_body_text',function( value ) {
		value.bind( function( newval ) {
			$('.connection-desc').css('color', newval );
		} );
	});
	//programs section
	wp.customize('programs_bg',function( value ) {
		value.bind( function( newval ) {
			$('.programs-area').css('background-color', newval );
		} );
	});
	wp.customize('programs_title',function( value ) {
		value.bind( function( newval ) {
			$('.programs-area .widget-title').css('color', newval );
		} );
	});
	wp.customize('programs_name',function( value ) {
		value.bind( function( newval ) {
			$('.program-name').css('color', newval );
		} );
	});
	wp.customize('programs_function',function( value ) {
		value.bind( function( newval ) {
			$('.program-position, .program-social a').css('color', newval );
		} );
	});
	wp.customize('programs_body_text',function( value ) {
		value.bind( function( newval ) {
			$('.program-desc').css('color', newval );
		} );
	});
	//members section
	wp.customize('members_bg',function( value ) {
		value.bind( function( newval ) {
			$('.members-area').css('background-color', newval );
		} );
	});
	wp.customize('members_title',function( value ) {
		value.bind( function( newval ) {
			$('.members-area .widget-title').css('color', newval );
		} );
	});
	wp.customize('members_client',function( value ) {
		value.bind( function( newval ) {
			$('.client-name').css('color', newval );
		} );
	});
	wp.customize('members_function',function( value ) {
		value.bind( function( newval ) {
			$('.client-function').css('color', newval );
		} );
	});
	wp.customize('members_body_bg',function( value ) {
		value.bind( function( newval ) {
			$('.member-body').css('background-color', newval );
		} );
	});
	wp.customize('members_body_text',function( value ) {
		value.bind( function( newval ) {
			$('.member-body').css('color', newval );
		} );
	});
	//Skills section
